...
$num_of_rows=mysqli_num_rows($result_query);
if($num_of_rows==0){
   echo "<h2 class='text-center text-danger'>&nbsp &nbsp  &nbsp &nbsp &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  No results match. No products found on this category!</h2>";
}
while($row=mysqli_fetch_assoc($result_query)){
    $product_id=$row['product_id'];
    $product_title=$row['product_title'];
    ...
    if(!isset($_GET['edit_account'])){
      if(!isset($_GET['my_orders'])){
        if(!isset($_GET['delete_account'])){
          ...
          if($row_count>0){
            echo "<h3 class='text-center text-success mt-2 mb-2'>  You have <span 
            class='text-danger'>$row_count</span> pending orders</h3>
            <p class='text-center mt-5 mb-2'><a href='profile.php?my_orders' class='text-dark'>Order Details</a></p>";
           }else{
             echo "<h3 class='text-center text-success mt-2 mb-2'> You have Zero pending orders</h3>
             <p class='text-center mt-5 mb-2'><a href='../index.php' class='text-dark'>Explore products</a></p>";
           }
        }
      }
    }
